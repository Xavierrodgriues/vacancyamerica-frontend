                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    <label className="block text-[#102A43] font-semibold text-xs uppercase ml-1">Business Username</label>
                                    <input
                                        type="text"
                                        name="username"
                                        ...
                                        placeholder="business_user"
                                        disabled={isLoading}
                                    />
                                </div>
                                <div className="space-y-1.5">
                                    <label className="block text-[#102A43] font-semibold text-xs uppercase ml-1">Business Name</label>
                                    <input
                                        type="text"
                                        name="display_name"
                            ...
                            <div className="space-y-1.5">
                                <label className="block text-[#102A43] font-semibold text-xs uppercase ml-1">Business Email</label>
                                <input
                                    type="email"
                                    name="email"
